...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalScrollable">
  ...
  <div class="col-sm-3 overflow-auto" style="max-height:100vh;">
      <?php echo '<img style="height:250px;" src="../../pp/'.sha1($_SESSION["name"]).'" class="card-img-top" alt="your profile photo">' ?>
...
<form method="post" action="../scripts/company.forward_s.php">
<?php include '../scripts/maininterface.companies_s.php' ?>
</form>
</nav>
  </div>
  <div class="col-sm-8" style="padding-top:5vh;padding-left:5vw;">
